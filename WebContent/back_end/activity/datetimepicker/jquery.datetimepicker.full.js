...
//高度			verticalPosition = (dateInputOffset.top + dateInputElem.offsetHeight) - 1;
				verticalPosition = (dateInputOffset.top) - 110;
//寬度			left = dateInputOffset.left;
				left = dateInputOffset.left + 210;
				position = "absolute";
